    ...
    return (
        <div className='port-container' id='portfolio'>
            <div className='gallery-grid-1'>
                ...
                <div className='image image-1' data-aos = 'zoom-in'>

                </div>
                <div className='image image-2' data-aos = 'zoom-in' data-aos-delay='200'>

                </div>
                <div className='image image-3' data-aos = 'zoom-in' data-aos-delay='300'>

                </div>
            </div>
            <div className='gallery-grid-2'>
                <div className='image image-4' data-aos = 'zoom-in' data-aos-delay='500'>

                </div>
                <div className='image image-5' data-aos = 'zoom-in' data-aos-delay='600'>

                </div>
                <div className='image image-6' data-aos = 'zoom-in' data-aos-delay='700'>

                </div>
                <div className='image image-7' data-aos = 'zoom-in' data-aos-delay='800'>
